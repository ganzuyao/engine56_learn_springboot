package com.engine56.consumer.shiro;
...
import com.engine56.consumer.config.ShiroCasConfiguration;

public class EgShiroCasRealm extends CasRealm {
	
	private static final Logger logger = LoggerFactory.getLogger(EgShiroCasRealm.class);
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        if(loginName!=null){
            ...
            info.addRole("role1");
            //添加权限
            info.addStringPermission("role1:manager");
            
            logger.info("已为用户["+loginName+"]赋予了[role1]角色和[role1:manager]权限");
            return info;
        }
